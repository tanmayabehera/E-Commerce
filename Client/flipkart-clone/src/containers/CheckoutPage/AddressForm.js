    ...
    return (
      <>
        ...
        <div style={{margin:"20px 0 0 0"}}>
          <label style={{color:"grey", fontSize:"14px"}}>Address Type</label>
          <div className="flexRow" style={{margin:"2px 0px 0 -6px"}}>
            <div>
              <input
                type="radio"
                ...
                value="home"
              />
              <span style={{color:"grey", fontSize:"16px"}}>Home</span>
            </div>
            <div>
              <input
                type="radio"
                ...
                value="work"
              />
              <span style={{color:"grey", fontSize:"16px"}}>Work</span>
            </div>
          </div>
        </div>
        <div className="flexRow">
